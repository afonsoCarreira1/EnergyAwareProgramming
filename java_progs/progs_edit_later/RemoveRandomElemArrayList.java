...
public class RemoveRandomElemArrayList {
    static int SIZE = 10_000_000;
    static int loopSize = 1_000;
    
    private static void removeRandomElemArrayList(ArrayList<Integer> list,int n) {
        list.remove(n);
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        int num = ArrayListAux.getRandomNumberHalved();
        ...
        while (end - begin < 1000000000/*1s*/) {
            removeRandomElemArrayList(list,num);
            end = System.nanoTime();
            i++;
        }
