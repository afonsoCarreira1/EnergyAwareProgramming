...
public class Template_addAll_int_java_util_Collection_ {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        try {
            ...
            TemplatesAux.writeErrorInFile("Template_addAll_int_java_util_Collection_", "Out of memory error caught by the program.\n" + e.getMessage());
        } catch (Exception e) {
            // TemplatesAux.writeErrorInFile("BubbleSort"filename"","Error caught by the program.\n"+e.getMessage());
            TemplatesAux.writeErrorInFile("Template_addAll_int_java_util_Collection_", "Error caught by the program.\n" + e.getMessage());
        } finally {
