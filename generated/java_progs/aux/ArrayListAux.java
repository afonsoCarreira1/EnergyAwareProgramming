...
public class ArrayListAux {
    ...
    public static <T> T getRandomValueOfTypeOutsideBounds(String type) {
        switch (type.toLowerCase()) {
            case "int" :
            case "integer" :
                return ((T) (Integer.valueOf(rand.nextBoolean() ? -rand.nextInt(50001)// Generates values between -50,000 and -1
                 : rand.nextInt(50001) + 100001)));// Generates values between 100,001 and 150,000

            case "double" :
                return ((T) (Double.valueOf(rand.nextBoolean() ? -rand.nextInt(50001) : rand.nextInt(50001) + 100001)));
            case "float" :
                return ((T) (Float.valueOf(rand.nextBoolean() ? -rand.nextInt(50001) : rand.nextInt(50001) + 100001)));
            case "long" :
                return ((T) (Long.valueOf(rand.nextBoolean() ? -rand.nextInt(50001) : rand.nextInt(50001) + 100001)));
            case "boolean" :
                return ((T) (Boolean.valueOf(rand.nextBoolean())));
            case "short" :
                return ((T) (Short.valueOf(((short) (rand.nextBoolean() ? -rand.nextInt(50001) : rand.nextInt(50001) + 100001)))));
            case "character" :
                char randomChar = ((char) ((rand.nextBoolean()) ? 'a' - (rand.nextInt(26) + 1) : 'z' + (rand.nextInt(26) + 1)));
                return ((T) (Character.valueOf(randomChar)));
            default :
                throw new IllegalArgumentException("Unsupported type: " + type);
        }
