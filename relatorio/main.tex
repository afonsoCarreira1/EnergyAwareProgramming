...
\newcommand{\wo}[1]{\textcolor{cyan}{WO: #1}}
...
%
\newcommand{\TITULO}{Energy Aware Programming}
\newcommand{\Autor}{Afonso Vaz dos Santos Silva Carreira}

%Orientador e CoOrientador *sem* titulos (e.g. Prof. Doutor)
\newcommand{\Orientador}{Alcides Miguel Cachulo Aguiar Fonseca}
\newcommand{\PCoOrientador}{Wellington Oliveira Júnior} %se nao se aplicar, nao importa o que aqui esteja
