...
%\begin{figure}
%  \centering
%  \includegraphics[width = 0.7 \textwidth]{figures/template_example.pdf}
%  \caption{Template Example for HashMap.put(Object, Object)}
...
package com.generated_progs.HashMap_put_java_lang_Object_java_lang_Object_;
