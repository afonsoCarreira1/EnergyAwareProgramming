...
There are several Java parsing tools, like WALA\cite{wala_main}, SootUp\cite{sootup_main}, Spoon\cite{spoon_main}, and so on. In this project, Spoon was selected, as it is a user-friendly tool that easily allows to obtain the code AST.
