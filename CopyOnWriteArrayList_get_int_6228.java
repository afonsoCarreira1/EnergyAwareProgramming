...
// add imports
public class CopyOnWriteArrayList_get_int_6228 {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            ArrayListAux.insertRandomNumbers(var0, 57897, "Character");
            int var1 = 51669;
            ...
            while (end - begin < 1000000000 && iter < arr.length) {
                copyOnWriteArrayList_get_int_6228(arr[iter].var0, arr[iter].var1);
            ...
            TemplatesAux.writeErrorInFile("CopyOnWriteArrayList_get_int_6228", "Out of memory error caught by the program:\n" + e.getMessage());
        } catch (Exception e) {
            // TemplatesAux.writeErrorInFile("BubbleSort"filename"","Error caught by the program.\n"+e.getMessage());
            TemplatesAux.writeErrorInFile("CopyOnWriteArrayList_get_int_6228", "Error caught by the program:\n" + e.getMessage());
        } finally {
    ...
    private static void copyOnWriteArrayList_get_int_6228(CopyOnWriteArrayList var, int arg0) {
        var.get(arg0);
    }
    ...
    private static void computation(BenchmarkArgs[] args, int iter) {
        ...
        while (!TemplatesAux.stop && i < iter) {
              copyOnWriteArrayList_get_int_6228(args[i].var0, args[i].var1);
               i++;
        };
    }
    ...
    private String input1 = "57897";

    private String input3 = "51669";
}
