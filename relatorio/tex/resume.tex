...
\wo{O resumo está muito grande. Tenta manter ele numa página só.}
...
Poupar energia ao nível de aplicações é importante para todas as categorias de dispositivos eletrónicos desde dispositivos móveis a centros de dados. No entanto, em 2020 estima-se que cerca de 7\% da energia elétrica global seja utilizada \wo{acho que há um problema de concordancia temporal aqui. 2020 foi no passado.} para fins de tecnologia da informação e comunicação, e com um aumento previsto em linha com a crescente procura por novas tecnologias, esse número tem tendência a aumentar \wo{tem ou teria?}.
...
\st{Embora a framework suporte a geração e análise de programas para diversas estruturas} \wo{"para ilustrar o funcionamento da framework"} neste trabalho foram recolhidos dados para as coleções \texttt{List} e \texttt{Map} da linguagem Java, que serviram de base para o treino e validação dos modelos.
