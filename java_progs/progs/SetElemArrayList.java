...
public class SetElemArrayList {
    static int SIZE = 10_000_000;
    static int loopSize = 1_000;
    
    private static void setElemArrayList(ArrayList<Integer> list,int i, int n) {
        list.set(i,n);
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        int pos = ArrayListAux.rand.nextInt(SIZE + 1);
