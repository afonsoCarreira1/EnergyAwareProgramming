...
// add imports
public class Prog_ArrayList_removeAll_java_util_Collection_ {
    ...
    public static void main(String[] args) throws Exception {
        int iter = 0;
        Integer in0 = Integer.valueOf(args[0]);
        ...
        try {
            ...
            ArrayListAux.insertRandomNumbers(var1, ((int) (in0)), "Integer");
    ...
    static class BenchmarkArgs {
        ...
        BenchmarkArgs(ArrayList<Integer> var0, ArrayList<Integer> var1) {
            ...
            this.var1 = DeepCopyUtil.deepCopy(var1, new TypeReference<ArrayList<Integer>>() {});
        }
    }

    private static void arrayList_removeAll_java_util_Collection_(ArrayList var, Collection<?> arg0) {
        var.removeAll(arg0);
    }
    ...
    private static int computation(BenchmarkArgs[] args, int iter) {
        ...
        while ((!TemplatesAux.stop) && (i < iter)) {
            arrayList_removeAll_java_util_Collection_(args[i].var0, args[i].var1);
            i++;
        } 
        return iter;
    }

    private static void populateArray(BenchmarkArgs[] arr, ArrayList<Integer> var0, ArrayList<Integer> var1) {
